...
export default function TestimonialsSection() {
  ...
  const testimonials = [
    {
      name: "Rajesh Kumar",
      role: t("testimonials.users.rajesh.role"),
      initial: "R",
      quote: t("testimonials.users.rajesh.quote"),
    },
    {
      name: "Priya Sharma",
      role: t("testimonials.users.priya.role"),
      initial: "P",
      quote: t("testimonials.users.priya.quote"),
    },
    {
      name: "Mohammed Ali",
      role: t("testimonials.users.ali.role"),
      initial: "M",
      quote: t("testimonials.users.ali.quote"),
    },
  ];
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-10">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-green-900">
            ...
            <br />
            <span className="text-green-700">{t("testimonials.title2")}</span>
          </h2>
        ...
        <div className="grid gap-8 md:grid-cols-3">
          {testimonials.map((item, index) => (
            <article
              key={index}
              className="relative rounded-2xl bg-white shadow-lg p-6 flex flex-col justify-between"
            >
              <div className="absolute top-6 right-6 text-4xl text-green-100">
                ❝
              </div>
