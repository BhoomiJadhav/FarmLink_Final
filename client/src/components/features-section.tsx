...
export default function FeaturesSection() {
  ...
  const features = [
    {
      icon: "💧",
      title: t("features.list.simple.title"),
      description: t("features.list.simple.desc"),
      image: "/contract.avif",
    },
    {
      icon: "🌡️",
      title: t("features.list.negotiation.title"),
      description: t("features.list.negotiation.desc"),
      image: "/negotiate.webp",
    },
    {
      icon: "🌾",
      title: t("features.list.reminder.title"),
      description: t("features.list.reminder.desc"),
      image: "/remainder.jpg",
    },
    {
      icon: "📊",
    ...
    {
      icon: "📱",
      title: t("features.list.advisory.title"),
      description: t("features.list.advisory.desc"),
      image: "/expert.jpg",
    },
    {
      icon: "🔔",
      title: t("features.list.dispute.title"),
      description: t("features.list.dispute.desc"),
      image: "/dispute.jpg",
    },
  ];
  ...
  return (
    <section id="features" className="py-24 bg-white relative">
      {/* HEADER */}
      <div className="max-w-4xl mx-auto px-4 text-center mb-20">
        <span className="inline-block px-6 py-2 bg-green-100 text-green-700 font-semibold rounded-full text-sm mb-4">
          {t("features.tag")}
        </span>
        ...
        <h2 className="text-4xl md:text-5xl font-extrabold text-gray-900 mb-6">
          {t("features.title1")}
          <br />
          <span className="text-green-700">{t("features.title2")}</span>
        </h2>
