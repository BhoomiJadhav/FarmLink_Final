  ...
  const steps = [
    {
      ...
      description: t("how.steps.step1.desc"),
      icon: "👤",
    },
    {
      number: "02",
      title: t("how.steps.step2.title"),
      description: t("how.steps.step2.desc"),
      icon: "📄",
    },
    {
      number: "03",
      title: t("how.steps.step3.title"),
      description: t("how.steps.step3.desc"),
      icon: "🖊️",
    },
    {
      number: "04",
      title: t("how.steps.step4.title"),
      description: t("how.steps.step4.desc"),
      icon: "📈",
    },
  ];
    ...
    <section id="how-it-works" className="py-20 relative">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-5xl font-extrabold text-green-900 leading-tight">
            {t("how.title1")}
            <span className="block text-green-700">{t("how.title2")}</span>
          </h2>
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          {steps.map((step) => (
            <div
              key={step.number}
              className="relative rounded-3xl bg-white/80 backdrop-blur shadow-md hover:shadow-xl border flex flex-col h-full"
            >
              {/* Number */}
              <div className="absolute -top-6 left-6">
                <div className="h-12 w-12 rounded-full bg-yellow-400 text-white flex items-center justify-center text-lg font-bold">
                  {step.number}
                </div>
              </div>
