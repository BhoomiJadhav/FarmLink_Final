...
export default function PurposeSection() {
  ...
  const items = [
    {
      title: t("purpose.items.tech.title"),
      desc: t("purpose.items.tech.desc"),
    },
    {
      title: t("purpose.items.buyers.title"),
      desc: t("purpose.items.buyers.desc"),
    },
    {
      title: t("purpose.items.contracts.title"),
      desc: t("purpose.items.contracts.desc"),
    },
  ];
