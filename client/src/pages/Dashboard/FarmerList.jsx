...
//                       <p>🌾 Land: {f.farm?.farmSize || "--"} Acres</p>
//                       <p>💧 Irrigation: {f.farm?.irrigation || "--"}</p>
//                     </div>
...
//                   {selectedFarmer.personal?.fullName}
//                 </h2>
//                 <p className="text-sm text-gray-500 mt-1">
//                   📍{" "}
//                   {selectedFarmer.farm?.farmLocation ||
...
//                   {selectedFarmer.rating?.toFixed(1) || "0.0"}
//                 </p>
//                 <p className="text-xs text-gray-500">
//                   ⭐ ({selectedFarmer.reviewsCount || 0} reviews)
//                 </p>
//               </div>

//               <div className="bg-emerald-50 p-4 rounded-xl text-center">
//                 <p className="text-lg font-bold text-emerald-700">
//                   {selectedFarmer.trustScore || 0}
//                 </p>
...
//                   {selectedFarmer.farm?.farmSize || "--"} Acres
//                 </p>
//               </div>
...
//                 <p className="font-semibold text-slate-800">
//                   {selectedFarmer.farm?.irrigation || "--"}
//                 </p>
//               </div>

//               <div className="bg-gray-50 p-4 rounded-xl col-span-2">
//                 <p className="text-xs text-gray-500 mb-1">Machinery</p>
//                 <p className="font-semibold text-slate-800">
//                   {selectedFarmer.farm?.machinery || "--"}
//                 </p>
//               </div>
//             </div>
...
//                 {(selectedFarmer.farm?.cropTypes || []).map((c, i) => (
//                   <span
//                     key={i}
//                     className="bg-gray-100 px-3 py-1 text-xs rounded-full font-medium"
//                   >
//                     {c}
//                   </span>
//                 ))}
...
//               <button
//                 onClick={() =>
//                   (window.location.href = `/buyer/cultivation-contract/${selectedFarmer.userId._id}`)
//                 }
...
//               <button
//                 onClick={() => setSelectedFarmer(null)}
//                 className="px-5 py-2 bg-gray-200 rounded-lg hover:bg-gray-300 text-sm"
//               >
//                 Close
//               </button>
//             </div>
