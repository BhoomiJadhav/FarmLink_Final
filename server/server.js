// // server.js (patched) — replace or merge with your current server.js
...
// // io.on("connection", (socket) => {
// //   console.log("socket connected:", socket.id);
// //   // You can join rooms here if you want per-user notifications
// //   socket.on("disconnect", () => {
// //     console.log("socket disconnected:", socket.id);
// //   });
// // });
...
// // }
// // Expose helpers to broadcast updates from routes or admin actions
// // function broadcastMarketUpdate(payload) {
// //   io.emit("market:update", payload);
// // }

// // function broadcastGovUpdate(payload) {
// //   io.emit("gov:update", payload);
// // }
